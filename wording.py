...
WORDING : Dict[str, Any] =\
{
	...
	'uis':
	{
		...
		'preset_manager_dropdown': 'PRESET',
		'preset_manager_name_textbox': 'NEW PRESET NAME',
		'preset_manager_save_button': 'SAVE',
		'preset_manager_delete_button': 'DELETE',
		'source_browse_button': 'BROWSE SWAP FOLDER'
	}
}
